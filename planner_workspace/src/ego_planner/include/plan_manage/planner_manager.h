...
namespace ego_planner
{
  ...
  public:
    ...
    struct ReplanStatus
    {
      ...
      bool terminal_in_obstacle{false};
      std::string failure_reason{"idle"};
    ...
    const ReplanStatus &getLastReplanStatus(void) const { return last_replan_status_; }
  ...
  private:
    ...
    ReplanStatus last_replan_status_;
