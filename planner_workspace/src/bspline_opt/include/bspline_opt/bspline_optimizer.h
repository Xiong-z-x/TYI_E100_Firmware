...
namespace ego_planner
{
  ...
  public:
    ...
    inline bool stoppedForError(void) const { return force_stop_type_ == STOP_FOR_ERROR; }
    inline bool stoppedForRebound(void) const { return force_stop_type_ == STOP_FOR_REBOUND; }
